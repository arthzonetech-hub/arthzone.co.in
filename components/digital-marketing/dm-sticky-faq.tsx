...
import type { DMFAQ } from "@/lib/digital-marketing-content";

export default function DmStickyFaq({ faqs, badge }: { faqs: DMFAQ[]; badge: string }) {
    ...
    <section className="border-t border-white/10 bg-[#101010] px-4 py-16 sm:px-6 md:py-24 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-14 lg:items-start">
          {/* Sticky left — stays visible while FAQ column scrolls on tall viewports */}
          <div className="lg:sticky lg:top-28 lg:max-w-lg">
            ...
            <p className="mt-4 text-base leading-relaxed text-gray-400 md:text-lg">
              Find quick answers to common questions about our services and support. If you
              don&apos;t see what you&apos;re looking for, contact us or book a free call!
            </p>
