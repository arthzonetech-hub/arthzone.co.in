...
//   description:
//     "iOS, Android, and cross-platform app development by Arthzone Technologies. We build fast, scalable mobile apps for startups and enterprises across India.",
// };

// const services = [
//   { icon: "🍎", title: "iOS App Development", desc: "Native Swift apps for iPhone and iPad — performant, beautiful, and App Store ready." },
//   { icon: "🤖", title: "Android App Development", desc: "Native Kotlin apps for the full Android ecosystem with Google Play publishing support." },
//   { icon: "⚛️", title: "React Native", desc: "One codebase, both platforms. Faster delivery without compromising on native performance." },
//   { icon: "💙", title: "Flutter Apps", desc: "Google's UI toolkit for stunning cross-platform apps from a single codebase." },
//   { icon: "🔗", title: "API & Backend", desc: "Robust REST and GraphQL APIs, Firebase, and Node.js backends powering your app." },
//   { icon: "🛡️", title: "App Maintenance", desc: "Ongoing updates, bug fixes, OS compatibility, and performance monitoring post-launch." },
// ];

// const tech = ["React Native", "Flutter", "Swift", "Kotlin", "Node.js", "Firebase", "PostgreSQL", "AWS"];

// const stats = [
//   { val: "80+", label: "Apps Shipped" },
//   { val: "4.7★", label: "Avg. App Rating" },
//   { val: "10M+", label: "End Users Reached" },
//   { val: "3 Months", label: "Avg. Delivery Time" },
// ];

// const process = [
//   { num: "01", title: "Scope & Strategy", desc: "Define features, user flows, and tech stack. We map out every screen before writing line one of code." },
//   { num: "02", title: "UI/UX Design", desc: "Interactive Figma prototypes reviewed and approved before development begins." },
//   { num: "03", title: "Agile Development", desc: "2-week sprints with live demos so you see progress continuously." },
//   { num: "04", title: "QA & Launch", desc: "Rigorous testing across devices, App Store submission, and launch support." },
// ];
...
//             Apps Your Users<br />Will Actually Love
//           </h1>
//           <p className="text-gray-300 text-lg max-w-2xl mx-auto mb-8">
//             We build iOS, Android, and cross-platform apps that are fast, intuitive, and built
//             to scale — from MVP to millions of users.
//           </p>
...
//           <p className="text-gray-400 mb-10 max-w-xl">Native and cross-platform development for every use case.</p>
...
//         {/* PROCESS */}
//         <div>
//           <h2 className="text-3xl md:text-4xl font-bold mb-10">How We Build Your App</h2>
...
//           <h2 className="text-2xl md:text-3xl font-bold mb-3">Have an app idea?</h2>
//           <p className="text-gray-400 mb-6">Tell us about it — we'll give you a free estimate and roadmap.</p>
