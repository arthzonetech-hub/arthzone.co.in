...
//   title: "Graphic Design & UI/UX Services | Arthzone Technologies",
//   description:
//     "Professional graphic design and UI/UX services from Arthzone Technologies. Brand identity, logos, app UI, website design, and social media creatives.",
// };

// const services = [
//   { icon: "🎨", title: "Brand Identity", desc: "Logo, color palette, typography, and brand guidelines that make your business unforgettable." },
//   { icon: "📐", title: "UI/UX Design", desc: "User-centric interface design for web apps, mobile apps, and dashboards with full Figma prototypes." },
//   { icon: "🖥️", title: "Website Design", desc: "Beautiful, conversion-focused website mockups ready for handoff to development." },
//   { icon: "📲", title: "App UI Design", desc: "Polished iOS and Android app interfaces that users love from first tap." },
//   { icon: "📸", title: "Social Media Creatives", desc: "Scroll-stopping posts, stories, banners, and ad creatives for all platforms." },
//   { icon: "🖨️", title: "Print & Marketing", desc: "Business cards, brochures, flyers, posters, and packaging design." },
// ];

// const tools = ["Figma", "Adobe Illustrator", "Adobe Photoshop", "Adobe XD", "Canva Pro", "After Effects"];

// const portfolio = [
//   { cat: "Brand Identity", name: "RetailChain Rebrand", desc: "Full brand identity for a 20-location retail chain." },
//   { cat: "UI/UX", name: "FinTech Dashboard", desc: "Complex data dashboard redesign — 40% drop in support tickets." },
//   { cat: "App Design", name: "Health & Fitness App", desc: "iOS app UI/UX for a wellness startup, 4.8★ on App Store." },
//   { cat: "eCommerce UI", name: "Fashion Store", desc: "Shopify storefront design driving 2.8x conversion improvement." },
// ];
...
//             Design That Makes<br />People Stop & Look
//           </h1>
//           <p className="text-gray-300 text-lg max-w-2xl mx-auto mb-8">
//             From brand identity to app UI — we create visuals that communicate clearly,
//             build trust, and drive action. Every pixel has a purpose.
//           </p>
...
//         {/* SERVICES */}
//         <div>
//           <h2 className="text-3xl md:text-4xl font-bold mb-3">Design Services</h2>
//           <p className="text-gray-400 mb-10 max-w-xl">Everything from a logo to a full product UI — all under one roof.</p>
...
//             {tools.map((t) => (
//               <span key={t} className="px-5 py-2 bg-[#181818] border border-gray-700 rounded-xl text-gray-300 text-sm font-medium hover:border-[#11d7fa] hover:text-[#11d7fa] transition-colors">
//                 {t}
//               </span>
//             ))}
//           </div>
...
//         <div>
//           <h2 className="text-3xl md:text-4xl font-bold mb-10">Recent Work</h2>
//           <div className="grid sm:grid-cols-2 gap-5">
//             {portfolio.map((p) => (
//               <div key={p.name} className="bg-[#181818] border border-gray-800 rounded-2xl p-6 hover:border-gray-600 transition">
//                 <span className="text-xs font-semibold px-3 py-1 rounded-full bg-[#11d7fa]/10 text-[#11d7fa] mb-4 inline-block">
//                   {p.cat}
//                 </span>
...
//           <h2 className="text-2xl md:text-3xl font-bold mb-3">Let's create something beautiful</h2>
//           <p className="text-gray-400 mb-6">Share your brief and we'll send a proposal within 24 hours.</p>
