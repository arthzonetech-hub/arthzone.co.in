...
export const metadata = {
  title: "Website Development Company in Mandsaur | Arthzone Technologies",
  description:
    "Arthzone Technologies builds affordable, modern websites for businesses in Mandsaur. Custom web design, landing pages & maintenance. Get a free consultation today.",
};

const faqItems = [
  {
    q: "How much does website development cost in Mandsaur?",
    a: "Our website packages for Mandsaur businesses start from ₹4,999 for a basic business website. Custom projects are priced based on requirements. Contact us for a free quote.",
  },
  {
  ...
  {
    q: "Do you provide website maintenance in Mandsaur?",
    a: "Yes, we offer ongoing website maintenance and support plans to keep your site fast, secure, and up to date.",
  },
  {
    q: "Can you build a website for a small business in Mandsaur?",
    a: "Absolutely. We specialize in building websites for small and local businesses in Mandsaur — shops, restaurants, coaching institutes, clinics, and more.",
  },
  {
    q: "What is the best website development company in Mandsaur?",
...
export default function MandsaurPage() {
  return (
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "Website development company in Mandsaur.",
      ...
      >
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="max-w-2xl mx-auto text-gray-300 text-lg">
            We build modern, high-converting websites for businesses in Mandsaur
      ...
      <section className="py-20 px-6 max-w-4xl mx-auto space-y-16">
        ...
        <div>
          ...
          <p className="text-gray-400 leading-relaxed">
            Arthzone Technologies is a trusted website development company serving businesses in Mandsaur,
            ...
            Whether you are looking for an affordable website in Mandsaur or a fully custom web application,
            our team delivers quality solutions on time and within budget. With clients across Mandsaur and
        ...
        <div>
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">
            Our Website Development Services in Mandsaur
          </h2>
        ...
        <div>
          ...
          <p className="text-gray-400 mb-6">
            Affordable website development packages for businesses in Mandsaur. No hidden charges.
          </p>
        ...
        <div>
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">
            Why Your Mandsaur Business Needs a Website
          </h2>
          <ul className="space-y-2 text-gray-400">
            ...
            <li>• Rank on Google for searches like "best [your business] in Mandsaur"</li>
          </ul>
        </div>
        ...
        <div>
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">
            Industries We Serve in Mandsaur
          </h2>
        ...
        <div>
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">
            Why Choose Arthzone Technologies in Mandsaur
          </h2>
          <ul className="space-y-2 text-gray-400">
            ...
            <li>• Serving clients across Mandsaur and Madhya Pradesh</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              {
                name: "Kamlesh Verma",
                business: "Hardware Shop, Mandsaur",
              ...
              {
                name: "Priya Joshi",
                business: "Coaching Institute, Mandsaur",
        ...
        <div className="bg-[##7614EF]/10 border border-[##7614EF] rounded-2xl p-8 text-center">
          ...
          <p className="text-gray-400 mb-5">
            Get a free consultation and quote for your Mandsaur business today.
          </p>
          <a
            href="https://app.cal.com/arthzone-tech"
