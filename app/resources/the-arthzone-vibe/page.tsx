...
//   description:
//     "Discover The Arthzone Vibe — the culture, energy, and creative spirit behind Arthzone Technologies. How we work, what we stand for, and why it matters.",
// };

// const vibes = [
//   { emoji: "🔥", title: "We Ship Fast", desc: "Speed is not an afterthought — it's core to our culture. We move fast, iterate quickly, and never leave clients waiting. Done beats perfect." },
//   { emoji: "🎨", title: "Design Obsessed", desc: "We believe every pixel matters. Whether it's a website, an app, or a social post — if it's not beautiful, it's not done." },
//   { emoji: "💬", title: "Always Reachable", desc: "We don't hide behind tickets and SLAs. You message, we reply. That's the Arthzone promise." },
//   { emoji: "📊", title: "Data Beats Opinions", desc: "We don't guess. Every campaign decision, every design choice, every strategy is backed by data." },
//   { emoji: "🤝", title: "Partners, Not Vendors", desc: "We're in your corner long-term. Your wins are our wins. We celebrate your milestones like they're our own." },
//   { emoji: "🌍", title: "Local Roots, Global Standards", desc: "Built in India, built for the world. We bring global best practices to local businesses — no compromise." },
// ];

// const playlist = [
//   { title: "Morning standup at 9 AM sharp", icon: "☀️" },
//   { title: "Figma open in one tab, VS Code in another", icon: "💻" },
//   { title: "Lofi beats in the background", icon: "🎵" },
//   { title: "Client demo ready by Thursday", icon: "📱" },
//   { title: "Weekly team retro every Friday", icon: "🔄" },
//   { title: "Celebrate every launch — big or small", icon: "🚀" },
// ];

// const gallery = [
//   { label: "Team Retreat 2024", sub: "Coorg, Karnataka" },
//   { label: "Design Sprint", sub: "48 hrs, 3 new features" },
//   { label: "Client Launch Party", sub: "Our 100th project" },
//   { label: "Hackathon Win", sub: "MP Startup Summit 2023" },
// ];
...
//             This Is How We Work.<br />This Is Who We Are.
//           </h1>
//           <p className="text-gray-300 text-lg max-w-2xl mx-auto mb-8">
//             The Arthzone Vibe isn't a marketing term. It's the feeling you get when a team genuinely
//             loves what they do — and it shows in every project they touch.
//           </p>
//           <div className="flex flex-col sm:flex-row justify-center gap-4">
//             <Link href="/our-team" className="px-8 py-3 bg-[#4361ee] rounded-xl font-semibold hover:bg-white hover:text-black transition">
//               Meet the Team
//             </Link>
//             <Link href="/career" className="px-8 py-3 border border-gray-600 rounded-xl font-semibold hover:border-white transition">
//               Join the Vibe →
//             </Link>
//           </div>
//         </div>
...
//         {/* MANIFESTO */}
//         <div className="border-l-4 border-[#11d7fa] pl-8 py-2">
//           <p className="text-xl md:text-2xl text-gray-200 leading-relaxed italic font-light">
//             "We started Arthzone not to build websites — but to build businesses. Every line of code,
//             every campaign, every logo we create is in service of someone's dream. That's the vibe."
//           </p>
//           <p className="text-[#11d7fa] font-semibold mt-4">— Arthzone Founder</p>
//         </div>

//         {/* VIBES */}
//         <div>
//           <h2 className="text-3xl md:text-4xl font-bold mb-10">The Six Pillars of the Vibe</h2>
//           <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
//             {vibes.map((v) => (
//               <div key={v.title} className="bg-[#181818] border border-gray-800 rounded-2xl p-6 hover:border-[#11d7fa] transition-colors">
...
//               {playlist.map((item) => (
//                 <div key={item.title} className="flex items-center gap-4 border border-gray-800 rounded-xl p-4">
...
//           </div>
//           <div>
//             <h2 className="text-3xl font-bold mb-6">Moments We Remember</h2>
//             <div className="grid grid-cols-2 gap-4">
//               {gallery.map((g) => (
//                 <div key={g.label} className="bg-[#181818] border border-gray-800 rounded-2xl p-5 aspect-square flex flex-col justify-end hover:border-gray-600 transition">
...
//         {/* CTA */}
//         <div className="bg-gradient-to-r from-[#4361ee]/20 to-[#11d7fa]/10 border border-[#4361ee] rounded-2xl p-10 text-center">
//           <h2 className="text-2xl md:text-3xl font-bold mb-3">Feel the vibe yourself</h2>
//           <p className="text-gray-400 mb-6">Hop on a call with us — no pitch, just a conversation.</p>
//           <div className="flex flex-col sm:flex-row justify-center gap-4">
