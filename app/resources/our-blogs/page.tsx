...
//   title: "Blog | Arthzone Technologies — Web, Marketing & Design Insights",
//   description:
//     "Read the Arthzone blog for expert insights on web development, digital marketing, UI/UX design, eCommerce, and growing your business online.",
// };

// const featured = {
//   category: "SEO",
//   title: "How Local Businesses in Madhya Pradesh Can Rank #1 on Google",
//   excerpt: "A step-by-step guide to local SEO for small businesses in MP — from Google My Business to on-page optimization and citations.",
//   date: "March 2025",
//   readTime: "8 min read",
//   slug: "#",
// };
...
// const posts = [
//   { cat: "Web Development", title: "Next.js vs WordPress: Which is Better for Your Business Website in 2025?", date: "Feb 2025", time: "6 min", slug: "#" },
//   { cat: "eCommerce", title: "Shopify vs WooCommerce: The Complete Comparison for Indian Sellers", date: "Feb 2025", time: "9 min", slug: "#" },
//   { cat: "Digital Marketing", title: "How to Set Up Google Ads for a Local Business — Step by Step", date: "Jan 2025", time: "7 min", slug: "#" },
//   { cat: "UI/UX", title: "5 UI Mistakes Killing Your Website Conversions (And How to Fix Them)", date: "Jan 2025", time: "5 min", slug: "#" },
//   { cat: "App Development", title: "React Native vs Flutter in 2025: Which Should You Choose?", date: "Dec 2024", time: "8 min", slug: "#" },
//   { cat: "SEO", title: "Technical SEO Checklist for Next.js Websites — 2025 Edition", date: "Dec 2024", time: "10 min", slug: "#" },
//   { cat: "eCommerce", title: "How to Increase Shopify Store Revenue Without Spending More on Ads", date: "Nov 2024", time: "7 min", slug: "#" },
//   { cat: "Digital Marketing", title: "Meta Ads vs Google Ads: Where Should Your Budget Go?", date: "Nov 2024", time: "6 min", slug: "#" },
// ];
...
//             Insights to Grow<br />Your Business Online
//           </h1>
//           <p className="text-gray-300 text-lg max-w-2xl mx-auto">
//             Practical guides on web development, digital marketing, design, and eCommerce —
//             written by the Arthzone team.
//           </p>
//         </div>
//       </section>
...
//         {/* FEATURED */}
//         <div>
//           <p className="text-[#11d7fa] text-sm font-semibold uppercase tracking-widest mb-4">Featured Article</p>
//           <Link href={featured.slug} className="block bg-[#181818] border border-[#11d7fa]/30 rounded-2xl p-8 hover:border-[#11d7fa] transition">
//             <span
//               className="text-xs font-semibold px-3 py-1 rounded-full mb-4 inline-block"
//               style={{ background: (catColors[featured.category] || "#11d7fa") + "22", color: catColors[featured.category] || "#11d7fa" }}
//             >
//               {featured.category}
//             </span>
//             <h2 className="text-2xl md:text-3xl font-bold mb-3 hover:text-[#11d7fa] transition-colors">{featured.title}</h2>
...
//             {posts.map((post) => (
//               <Link key={post.title} href={post.slug} className="bg-[#181818] border border-gray-800 rounded-2xl p-6 hover:border-gray-600 transition block">
//                 <span
//                   className="text-xs font-semibold px-3 py-1 rounded-full mb-4 inline-block"
//                   style={{ background: (catColors[post.cat] || "#888") + "22", color: catColors[post.cat] || "#888" }}
//                 >
//                   {post.cat}
//                 </span>
//                 <h3 className="font-bold text-base leading-snug mb-3 hover:text-[#11d7fa] transition-colors">{post.title}</h3>
...
//           <h2 className="text-2xl md:text-3xl font-bold mb-3">Get new articles in your inbox</h2>
//           <p className="text-gray-400 mb-6">No spam. Just practical insights, once a month.</p>
//           <div className="flex flex-col sm:flex-row justify-center gap-3 max-w-md mx-auto">
//             <input
//               type="email"
//               placeholder="your@email.com"
//               className="flex-1 px-4 py-3 bg-[#181818] border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-[#11d7fa]"
//             />
//             <button className="px-6 py-3 bg-[#4361ee] rounded-xl font-semibold hover:bg-white hover:text-black transition whitespace-nowrap">
//               Subscribe
//             </button>
//           </div>
//         </div>
