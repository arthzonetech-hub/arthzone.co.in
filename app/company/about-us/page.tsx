...
//   title: "About Us | Arthzone Technologies and Soft. Solutions",
//   description:
//     "Learn about Arthzone Technologies — a software and digital solutions company based in Madhya Pradesh, India. Our story, mission, and values.",
// };

// const values = [
//   { icon: "🎯", title: "Results First", desc: "Every decision we make is tied to one question: does this move the needle for our client?" },
//   { icon: "🤝", title: "Long-Term Partnership", desc: "We're not a vendor — we're a partner. We invest in your success because your growth is our growth." },
//   { icon: "💡", title: "Honest Advice", desc: "We tell you what you need to hear, not what you want to hear. That's how trust is built." },
//   { icon: "⚡", title: "Speed Without Compromise", desc: "Fast delivery is our standard. Quality is non-negotiable. We don't make you choose between the two." },
// ];

// const milestones = [
//   { year: "2020", title: "Founded", desc: "Arthzone Technologies was started with a mission to bring world-class digital solutions to Indian businesses." },
//   { year: "2021", title: "First 50 Clients", desc: "Grew rapidly through referrals, serving businesses across Madhya Pradesh." },
//   { year: "2022", title: "Shopify Select Partner", desc: "Recognized as a Shopify Select Partner for our eCommerce expertise." },
//   { year: "2023", title: "Expanded Services", desc: "Launched full-service digital marketing and app development divisions." },
//   { year: "2024", title: "200+ Projects", desc: "Crossed 200 projects delivered across website, app, design, and marketing." },
//   { year: "2025", title: "Going Global", desc: "Serving clients across India, UK, UAE, and USA with a growing remote team." },
// ];
...
//             We Build Digital Products<br />That Actually Work
//           </h1>
//           <p className="text-gray-300 text-lg max-w-2xl mx-auto mb-8">
//             Arthzone Technologies is a full-service digital agency helping businesses build their
//             online presence, grow their audience, and scale their revenue — since 2020.
//           </p>
...
//               Work With Us
//             </Link>
//             <Link href="/our-team" className="px-8 py-3 border border-gray-600 rounded-xl font-semibold hover:border-white transition">
//               Meet the Team
//             </Link>
//           </div>
//         </div>
...
//               We started Arthzone with a simple belief: every business — no matter how small or
//               how local — deserves access to world-class digital tools and expertise.
//             </p>
//             <p className="text-gray-400 leading-relaxed mb-4">
//               Too many agencies charge a fortune and deliver mediocre work. We set out to be
//               different — transparent, skilled, and genuinely invested in our clients' success.
//             </p>
//             <p className="text-gray-400 leading-relaxed">
//               Today, we serve businesses across India and globally, but our ethos remains the
//               same: deliver exceptional work, on time, every time.
//             </p>
//           </div>
...
//             ].map((s) => (
//               <div key={s.val} className="bg-[#181818] border border-gray-800 rounded-2xl p-6 text-center">
//                 <p className="text-3xl font-black text-[#11d7fa]">{s.val}</p>
...
//         {/* VALUES */}
//         <div>
//           <h2 className="text-3xl md:text-4xl font-bold mb-10">What We Stand For</h2>
...
//         {/* TIMELINE */}
//         <div>
//           <h2 className="text-3xl md:text-4xl font-bold mb-10">Our Journey</h2>
//           <div className="relative border-l border-gray-800 pl-8 space-y-8">
//             {milestones.map((m) => (
//               <div key={m.year} className="relative">
//                 <div className="absolute -left-[41px] w-4 h-4 rounded-full bg-[#11d7fa] border-2 border-[#101010]" />
//                 <span className="text-[#11d7fa] text-sm font-bold">{m.year}</span>
...
//           <p className="text-gray-400 mb-6">Let's build something great for your business.</p>
//           <div className="flex flex-col sm:flex-row justify-center gap-4">
//             <Link href="https://app.cal.com/arthzone-tech" className="px-8 py-3 bg-[#4361ee] rounded-xl font-semibold hover:bg-white hover:text-black transition">
//               Book a Call
//             </Link>
